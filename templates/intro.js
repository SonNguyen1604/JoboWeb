...
app.controller('introController', function ($state, $scope, $rootScope, $timeout, CONFIG) {
    ...
    .controller('signupCtrl', function ($scope, $rootScope, $stateParams, $http, $state) {
                ...
                userRef.once('value', function (snap) {
                    ...
                    if (snap.val()) {
                        ...
                        if (!type) {
                            ...
                            $scope.openModal()
                            // A confirm dialog
                            $scope.typeEmployer = function () {
                                type = 1
                                createDataUser(userRef, userData, type)

                            }
                            $scope.typeJobseeker = function () {
                                type = 2
                                createDataUser(userRef, userData, type)
